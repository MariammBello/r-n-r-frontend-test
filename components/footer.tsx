...
export default function Footer() {
  return (
    <footer className="w-full bg-white pt-16 pb-8 border-t border-gray-100">
      <div className="w-full mx-auto px-[60px] relative">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-5 pointer-events-none">
          ...
          >
            <path
              d="M400 50L200 350H100V50H200V250L350 50H400Z"
              fill="#000000"
            />
          </svg>
        </div>
        ...
        <div className="grid grid-cols-4 gap-8 mb-16 relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  href="/about"
                  className="text-[#4f4f4f] hover:text-[#0e2f3c] transition-colors"
                >
                  About
                </Link>
              </li>
          ...
          {/* For Vendors column */}
          <div>
            <h3 className="text-[#0e2f3c] text-xl font-bold mb-6">
              For Vendors
            </h3>
            <ul className="space-y-4">
              <li>
        ...
        <div className="flex items-center justify-between pt-6 border-t border-gray-200">
          ...
          <div className="text-[#4f4f4f] text-sm">
            © 2025 Routes 'n' Routes. All rights reserved
          </div>
        </div>
      </div>
    </footer>
